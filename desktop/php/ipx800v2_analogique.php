    <div class="col-lg-9 eqLogic ipx800v2_analogique" style="border-left: solid 1px #EEE; padding-left: 25px;display: none;">
        ...
        <table id="table_cmd_ipx800v2_analogique" class="table table-bordered table-condensed ipx800v2_analogique">
            <thead>
                <tr>
